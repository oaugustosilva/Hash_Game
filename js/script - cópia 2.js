...
let contador = 2;
console.log('contador está 2 no início');
    ...
    boxes[i].addEventListener("click", function () { //Function that makes the X or O appears on the hash.
        ...
        */
        ...
        if (secondPlayer == 'b2-AI'){
            ...
            // console.log("Entrou no IF do botao AI. Contador: " + contador);
            checkPlayer();
            checkBoxes();
            // contador++;
        } else {
...
function checkPlayer(contador){ //routine to define who has the turn to play.
    if(contador%2===0){
        ...
        if(secondPlayer == 'b2-AI'){
            // console.log("entrou no if do player contra IA");
            computerPlayer();
            // contador++;
        }
    }
...
function winnerDeclarer(winner){
    ...
    //Beginning with 0 rounds;
    // contador = -1;
    // console.log(contador);
    // console.log("contador foi diminuido");
    ...
    contador = -1;
    // console.log("tentando voltar pro x: " + el);
}
